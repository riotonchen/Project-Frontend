<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      -->
      <el-button v-waves class="filter-item" type="primary" icon="el-icon-search" @click="handleFilter">{{ $t('c_project.search') }}</el-button>
      <el-button class="filter-item" style="margin-left: 0;" type="primary" icon="el-icon-edit" @click="handleCreate">{{ $t('c_project.data') }}</el-button>
      <!--
    ...
    <el-table v-loading="listLoading" :key="tableKey" :data="list" border fit highlight-current-row style="width: 100%;">
      <el-table-column :label="$t('c_project.name')" align="center" height="25vh">
      ...
      <el-table-column :label="$t('c_project.income')" height="25vh" align="center">
        <template slot-scope="scope">
