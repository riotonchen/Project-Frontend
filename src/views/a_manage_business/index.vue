  ...
  <div class="app-container">
    ...
    <div class="dialog_container">
      ...
      <el-dialog :visible.sync="dialogFormVisible" width="80vw">
        <el-form :data="a_business_subsort" label-position="left" inline class="table_category">
      ...
      <el-dialog :visible.sync="dialogTableVisible" width="80vw">
        ...
        <div class="dialog_avitvity">
          <el-dialog :visible.sync="a_business_visible" width="80vw" title="編輯">
            <el-form :model="a_business_edit" :rules="a_business_edit_rules" label-position="left" inline class="table-invoice">
              <el-form-item>
